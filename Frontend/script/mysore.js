document.addEventListener("DOMContentLoaded", function () {
    ...
    const artworks = [
        { id: 1, title: "Artwork 1", artist: "Artist A", price: 200, rating: 4.5, imageUrl: "images/mysore_cards.jpg" },
        { id: 2, title: "Artwork 2", artist: "Artist B", price: 150, rating: 4.0, imageUrl: "images/mysore_cards.jpg" },
        { id: 3, title: "Artwork 3", artist: "Artist C", price: 300, rating: 4.8, imageUrl: "images/mysore_cards.jpg" },
        { id: 1, title: "Artwork 1", artist: "Artist A", price: 200, rating: 4.5, imageUrl: "images/mysore_cards.jpg" },
        { id: 2, title: "Artwork 2", artist: "Artist B", price: 150, rating: 4.0, imageUrl: "images/mysore_cards.jpg" },
        { id: 3, title: "Artwork 3", artist: "Artist C", price: 300, rating: 3.9, imageUrl: "images/mysore_cards.jpg" },
        { id: 2, title: "Artwork 2", artist: "Artist B", price: 150, rating: 4.0, imageUrl: "images/mysore_cards.jpg" },
        { id: 3, title: "Artwork 3", artist: "Artist C", price: 300, rating: 4.8, imageUrl: "images/mysore_cards.jpg" },
    ...
    function displayArtworks(artworks) {
        ...
        artworks.forEach((artwork, index) => {
            ...
            ratingDropdown.addEventListener("change", function () {
                ...
                const previousTotalArtworks = artworks.length; // Get the previous total number of artworks
